      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-md shadow-md py-3' : 'bg-transparent py-5'}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <div className="w-10 h-10 bg-kaa-gold rounded-sm flex items-center justify-center text-kaa-navy font-serif font-bold text-xl shadow-sm">高</div>
        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-12">
            <div className="text-center md:text-left">
                <div className="text-kaa-navy font-serif font-bold text-3xl mb-4 flex items-center justify-center md:justify-start gap-3">
                    <div className="w-8 h-8 bg-kaa-gold text-kaa-navy rounded-sm flex items-center justify-center text-lg shadow-sm">高</div>
                    高雄市建築師公會
                </div>
